...
class RootActivity : BaseActivity<ArticleViewModel>(), IArticleView {
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        ...
        if (binding.isSearch) {
            ...
            if(binding.isFokusedSearch) searchView?.requestFocus()
    ...
    inner class ArticleBinding() : Binding() {
        var isFokusedSearch: Boolean = false
        ...
        override fun saveUi(outState: Bundle) {
            outState.putBoolean(::isFokusedSearch.name, search_view?.hasFocus() ?: false)
        }

        override fun restoreUi(savedState: Bundle) {
            isFokusedSearch = savedState.getBoolean(::isFokusedSearch.name)
        }
